//
//  DeleteContentApiClientTests.swift
//  Vincles BCN
//
...
class DeleteContentApiClientTests: XCTestCase {
    
    func testDeleteContentSuccess() {
        ...
        ApiClient.removeContentFromLibrary(contentId: 0, onSuccess: {
            expectation.fulfill()
