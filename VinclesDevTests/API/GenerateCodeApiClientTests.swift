//
//  GenerateCodeApiClientTests.swift
//  Vincles BCN
//
...
class GenerateCodeApiClientTests: XCTestCase {
    
   
    func testGenerateCodeSuccess() {
        ...
        ApiClient.generateCode(onSuccess: { (responseArray) in
